    ...
    <!-- <script src="js/jquery-1.6.2.min.js" type ="text/javascript"></script>
        ...
        <script>
            $(document).ready(function() {
                $( "#filterAnimalName" ).change(function() {
                    $.ajax({
...
<div class="container">
  ...
  <table class="table">
    <thead class="thead-light"><tr>
      <th scope="col" id="searchAnimalName">Animal Name</th>
    ...
    <tbody>
      ...
      if (mysqli_connect_errno()) {
        ...
        if($stmt->prepare('SELECT animal_name, population, type, region FROM Animals') or die(mysqli_error($db))) {
          $stmt->execute();
